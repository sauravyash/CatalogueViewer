package com.sauravyash.FileDrop;
...
public class FileDrop
{
    ...
    /**
     * Constructor with a default border and debugging optionally turned on.With Debugging turned on, more status messages will be displayed to
    <tt>out</tt>.
 ...
 <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for
     ...
     * and the option to recursively set drop targets.If your component is a <tt>java.awt.Container</tt>, then each of its children
 components will also listen for drops, though only the parent will change borders.
 ...
 components after you've set up the drag-and-drop. This will recursively unregister all components contained within
...
/* ********  I N N E R   C L A S S  ******** */
    ...
    /* ********  T R A N S F E R A B L E   M E T H O D S  ******** */    
        ...
        /**
         * Returns the data encapsulated in this {@link TransferableObject}.If the {@link Fetcher} constructor was used, then this is when
 the    {@link Fetcher#getObject getObject()} method will be called.If the requested data flavor is not supported, then the
